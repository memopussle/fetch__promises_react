...
var Movie = function Movie(props) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement("a", { href: "https://www.imdb.com/title/" + imdbID + "/", target: "_blank" }),
      React.createElement("img", { src: Poster, className: "img-fluid" })
    ),
    React.createElement(
      "div",
      { className: "col-8 cil-md-9 mb-3" },
      React.createElement("a", { href: "https://www.imdb.com/title/" + imdbID + "/", target: "_blank" }),
      React.createElement(
        "h4",
        null,
...
var MovieFinder = function (_React$Component) {
  ...
  _createClass(MovieFinder, [{
    ...
    value: function handleSubmit(event) {
      ...
      fetch("http://www.omdbapi.com/?s=" + searchTerm + "&apikey=824d122").then(checkStatus).then(json).then(function (data) {
        ...
        _this2.setState({ results: data.Search }); //data.Search: array of the movies and store it in results array
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "form",
              { className: "form-inline my-4", onSubmit: this.handleSubmit },
